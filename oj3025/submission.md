...
```text
Step 1:รับ input
Step 2:conditions month
Step 3:conditions day ในการเปลี่ยนฤดูตามวันที่กำหนด
Step 4:แสดง output
```
...
```text
เหมือนแผนแรก เนื่องจากแผนแรกทำงานได้ output ตามต้องการ
```
...
```text
เพื่อทดสอบว่า output ถูกต้องตามที่ต้องการ
```
...
```text
เพื่อตรวจสอบว่า output จะแสดงสลับเดือนเนื่องจากวันที่ 21 ขึ้นไป
```
...
```text
เพื่อตรวจสอบว่าจะแสดง output "fall" จากการที่ใช้ else ในการกำหนดเดือนนี้
```
