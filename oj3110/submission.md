...
output:
ราคานำส่งพัสดุ หรือ ERROR หากเส้นทางไม่ตรงที่กำหนด
...
```text
Step 1: รับ input
Step 2: สร้างตัวแปร total ไว้เก็บราคาที่ต้องจ่าย
Step 3: ใช้ if else ดูว่าต้นทางปลายทางตรงตามที่กำหนดไหม
Step 4: คำนวณราคาตามที่กำหนดแต่ละเส้นทาง และ บวกค่าธรรมเนียมเริ่่มต้น ในลงตัวแปร  total
Step 5: แสดง output
```
...
```text
เหมือนกับแผนแรก เพราะสามารถเช็คเส้นทางได้ถูกต้องและคำนวณราคาออกมาได้ถูกต้อง
```
...
```text
เพื่อดูว่าหากใส่ค่าเส้นทางลงไปเหมือนกัน จะแสดง Error ตามเงื่อนไข
```
...
```text
เพื่อตรวจสอบว่าหากใส่ตัวอักษรพิมำ์เล็กไปแล้วจะแสดงผล Error เนื่องจากโปรแกรมรับ input แค่ตัวอักษรพิมพ์ใหญ่
```
...
```text
เพื่อตรวจสอบว่า output ออกมาถูกต้องตามที่โจทย์ต้องการ
```
...
```text
วางแผนเอง เขียนcodeเอง ทดสอบเอง ส่งเอง
```
