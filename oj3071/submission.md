...
```text
input:
รับค่า a ค่าช่วงเริ่ม
รับค่า b ค่าจุดจบ
รับค่า d ค่าตัวหาร
รับค่า r ค่าเศษที่เหลือจากการหาร

output:
จำนวนตัวเลขระหว่าง a,b ที่หาร d แล้วได้เศษ r
...
```text
Step 1: รับ input
Step 2: สร้างตัวแปร count นับจำนวน
Step 3: เข้า for loop ช่วง a ถึง b+1
Step 4: ถ้าเจอตัวเลขที่ หาร d แล้วเหลือเศษ r นับจำนวนลงในตัวแปร count
Step 5: แสดง count
```
...
```text
เหมือนแผนแรก เพราะสามารถหาตัวเลขได้ตามที่โจทย์ต้องการ
```
...
```text
เพื่อตรวจสอบว่าโปรแกรมทำงานได้ตามต้องการ
```
...
```text
เพื่อตรวจสอบว่าสามารถหาตัวที่หารแล้วเหลือเศษออกมาครบตามจำนวน
```
...
```text
เพื่อตรวจสอบว่าถ้าไม่มีตัวไหนที่หารแล้วได้เศษตามที่กำหนดจะ output = 0
```
...
```text
วางแผนเอง เขียนcodeเอง แก้ไขเอง ส่งเอง
```
