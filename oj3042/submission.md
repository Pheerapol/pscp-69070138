...
output:
แสดงตัวเลขตั้งแต่ค่าที่ input จนถึง 0 ที่หาร 10 ลงตัวและแสดงใน 1 line

constraints:
แสดง output ทั้งหมดใน 1 บรรทัด
```
...
```text
Step 1:รับค่า input
Step 2:loop ตั้งแต่ n ถึง 0
Step 3:print ตัวที่หาร 10 ลงตัวและตั้ง argument ของ parameter end=" "
```
...
```text
เหมือนแผนแรก เพราะสามารถหาตัวเลขที่หาร 10 ลงตัวและแสดง output ในบรรทัดเดียวได้ตามที่โจทย์ต้องการ
```
...
```text
เพื่อตรวจสอบว่าโปรแกรมแสดง output ได้ตามที่โจทย์ต้องการ
```
...
```text
เพื่อตรวจสอบว่าแม้ input จะไม่ได้หาร 10 ลงตัวจะยังทำงานได้ตามที่ต้องการ
```
...
```text
เพื่อตรวจสอบว่าหากใส่แค่เลขหลักเดียว output จะออกมาแค่ 0
```
...
```text
วางแผนเอง เขียนcodeเอง ทดสอบเอง แก้ไขเอง ส่งเอง
```
