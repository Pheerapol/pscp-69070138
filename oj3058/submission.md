...
```text
Step 1:รับค่า
Step 2:คำนวณหาความต้องการใช้ b
Step 3:หาก ความต้องการมีค่าน้อยกว่าหรือเท่ากับ b จะบวกเข้า bridge
Step 4: คำนวณ a แบบเดียวกับ b
Step 5:แสดงผล จากความต้องการใช้ของ a 
```
...
```text
คล้ายแผนแรก เปลี่ยนตรงการคำนวณ b เป็นการใช้ min() เพื่อแม้ว่าความต้องการ b จะมากกว่า b ที่มีจะยังคงใช้ b ได้หมด
```
...
```text
เพื่อตรวจสอบว่า code ทำงานถูกต้องใช้ b จนหมด
```
...
```text
เพื่อตรวจสอบว่าหากไม่มีอิฐเลย output จะเป็น -1
```
...
```text
เพื่อตรวจสอบว่า code ทำงานถูกต้องตามที่ต้องการโดยที่ใช้ a ครบและไม่ใช้ b เกิน
```
...
```text
วางแผนแรกเอง เขียนcodeเอง ทดสอบเอง แก้ไขเอง ส่งเอง
```
