...
```text
input :
รับค่าอุณหภูมิ, รับหน่วยอุณหภูมิตั้งต้น, รับหน่วยอุณหภูมิที่ต้องการ

output :
แสดงค่าอุณหภูมิหลังการคำนวณเป็นหน่วยที่ต้องการ

constraints :
ใช้สูตรตามที่โจทย์กำหนด
...
```text
Step 1: รับค่าเข้าตัวแปร
Step 2: คำนวณตามสูตร
Step 3: แสดงผลทศนิยม 2 ตำแหน่ง
```
...
```text
step 1: รับค่าเข้าตัวแปรตามโจทยฺ์
step 2: คำนวณค่าที่รับเข้ามาเพื่อแปลงเป็น celcsius ตามหน่วยที่รับ
step 3: คำนวณแปลงจาก celsius เป็นเป็นที่ต้องการตาม input ตัวสุดท้าย
step 4: แสดงผลค่า output ออกมาตามที่คำนวณใน step 3
```
...
```text
เพื่อดทสว่าการคำนวณแปลงเป็น celsius ในตอนแรกได้ผลตามต้องการ
```
...
```text
เพื่อดูว่าหากให้แสดงค่าหน่วยเดิม การคำนวณทั้ง 2 ครั้งสามารถแสดงผลลัพตรงตามค่า input เดิม
```
...
```text
เพื่อดูว่าสูตรการคำนวณครั้งที่ 2 ของ R นั้นถูกต้อง
```
