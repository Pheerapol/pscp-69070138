...
```text
คล้ายแผนแรกแต่เพิ่มหากมีการรับเข้าสีเดียวกันทั้งสองสีจะแสดงสีนั้นออกมา
```
...
```text
เพื่อตรวจสอบว่าแสดง output ออกมาได้ตามต้องการ
```
...
```text
เพื่อตรวจสอบว่าหากมีการสลับ color1 กับ color2 จะยังแสดงผลได้ตามเดิม
```
...
```text
เพื่อทดสอบว่าหากมีการใส่สีเดิมทั้งสอง input จะได้ output เป็นสีนั้น
```
