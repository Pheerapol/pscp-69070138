...
output:
ยอดรวมเมื่อบวกค่า service และค่า vat
...
```text
Step 1:รับ input
Step 2:คำนวณค่า service จากราคา input
Step 3:เช็คช่วงราคา service เพื่อบวกในยอดรวม
Step 4:คำนวณค่า vat จากยอดรวม
Step 5: แสดง output ยอดรวมที่รวมค่า vat แล้ว
```
...
```text
เหมือนกับแผนแรก เนื่องจากสามารถแสดง output ได้ออกมาตามที่ต้องการ
```
...
```text
เพื่อตรวจสอบว่า output ออกมาได้ตามที่ต้องการในช่วง 50 ถึง 1000
```
...
```text
เพื่อตรวจสอบว่าค่า service จะหยุดแค่ 1000 หากคำนวณตามสูตรแล้วออกมาเกิน 1000
```
...
```text
เพื่อตรวจสอบว่าหากค่า service ที่คำนวณตามสูตรออกมาต่ำกว่า 50 จะบังคับให้ service = 50
```
...
```text
วางแผนเอง เขียนเอง ทดสอบเอง แก้ไขเอง ส่งเอง
```
